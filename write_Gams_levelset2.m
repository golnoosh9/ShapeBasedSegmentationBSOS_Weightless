function [coeffs,ws,exp_mat,R1,mv,l0,l0_new,mu,w,ee,c,indx1,indy1,cnum,cluster_num]= write_Gams_levelset2(im,file,fixed,weight,csize,dsize,rnum,begin,programRelaxOrder)
